...
const COLUMNS: Column[] = [
  {
    ...
    items: [
      ...
      { title: "Anime Catalog + Jikan Integration",   icon: BookOpen,     note: "24 titles, swappable provider"          },
      ...
      { title: "SEO + Structured Data",               icon: Cpu,          note: "JSON-LD, open graph, sitemap"           },
    ],
  },
  {
    status: "in-progress",
