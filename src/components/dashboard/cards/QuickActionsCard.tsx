...
const ACTIONS = [
  ...
  { icon: Star,       label: "Rate an Anime",     href: "/rate",        color: "text-accent-bright",   bg: "bg-accent/10",   border: "hover:border-white/40 hover:shadow-[0_0_20px_color-mix(in srgb, var(--app-accent-bright) 8%, transparent)]"  },
  { icon: Search,     label: "Search Archive",    href: "/search",          color: "text-accent-bright",  bg: "bg-accent/10",  border: "hover:border-white/40 hover:shadow-[0_0_20px_color-mix(in srgb, var(--app-accent) 8%, transparent)]" },
