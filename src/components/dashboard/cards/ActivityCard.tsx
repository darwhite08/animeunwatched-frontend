...
import { Clock, Bookmark, Star, Trophy, MessageCircle, Play, ArrowRight } from "lucide-react"
...
const ACTIVITIES: Activity[] = [
  ...
  { icon: Bookmark,      color: "text-indigo-400",  bg: "bg-indigo-500/10",  title: "Added to Archives",   anime: "Vagabond",             time: "2d ago",  href: "/readlist"      },
  ...
  return (
    <div className="p-8 rounded-[2.5rem] border border-white/5 bg-[#0a0a0a] flex flex-col gap-6 relative overflow-hidden group">
      ...
      <div className="flex items-center justify-between relative z-10">
        ...
        <Link href="/notifications" className="text-[9px] font-black uppercase tracking-widest text-indigo-400/60 hover:text-indigo-400 transition-colors flex items-center gap-1">
