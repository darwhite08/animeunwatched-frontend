          ...
          {filtered.length > 0 ? (
            ...
            >
              ...
              <button
                ...
                className="mt-2 px-5 py-2.5 rounded-xl bg-accent/20 border border-accent/20 text-xs font-black uppercase tracking-widest text-accent-bright hover:bg-white/30 transition-all"
              >
                Clear filters
              </button>
            </motion.div>
