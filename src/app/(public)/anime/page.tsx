...
export default function AnimeBrowsePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-32">
      {/* Hero */}
      <div className="border-b border-border bg-background/80 backdrop-blur-md sticky top-[var(--sticky-top,72px)] z-30">
        <div className="max-w-7xl mx-auto px-6 py-5">
          <h1 className="text-3xl font-black tracking-tighter uppercase italic text-foreground">
            Anime Browse<span style={{color:"var(--app-accent)"}}>.</span>
          </h1>
              ...
              <div key={s} className="space-y-2">
                ...
                {SEASONAL_YEARS.map(y => (
                  ...
                  >
                    ...
                    <span className="text-[9px] text-subtle group-hover:text-foreground transition-colors font-mono">
