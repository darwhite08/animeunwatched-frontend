    ...
    <div className="min-h-screen bg-background text-foreground pb-32">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-10 flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 min-h-11 px-2 -mr-2 text-[10px] font-black uppercase tracking-widest text-accent-bright hover:text-foreground transition-colors active:scale-95"
        >
