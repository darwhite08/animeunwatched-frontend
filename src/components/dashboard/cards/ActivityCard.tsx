...
export const ActivityCard = () => {
  ...
  return (
    <div className="p-8 rounded-[2.5rem] border border-border bg-surface flex flex-col gap-6 relative overflow-hidden group">
      <div className="absolute -right-8 -bottom-8 w-32 h-32 bg-accent/5 blur-[40px] rounded-full pointer-events-none group-hover:bg-white/10 transition-colors duration-700" />
