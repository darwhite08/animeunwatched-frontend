...
const BADGE_DB: Record<string, BadgeData> = {
  ...
  "social-butterfly": {
    ...
    description: "Joined 5 dens, followed 20 users, and had 50 posts liked by the community. The connective tissue of this platform.",
    rarity: "Epic",
    rarityColor: "text-violet-400",
    rarityBg: "bg-violet-500/10 border-violet-500/25",
    requirement: "5 dens + 20 follows + 50 post likes",
    requirementProgress: 62,
    earnedCount: 1240,
    icon: Award,
    steps: [
      "Join at least 5 community dens from the Dens page.",
