    ...
    <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12">
      <div className="space-y-4 text-center md:text-left">
        <div className="flex items-center justify-center md:justify-start gap-3">
          ...
          <span className="text-sm font-black uppercase tracking-[0.3em] text-white/40">Active Momentum</span>
        </div>
        <h2 className="text-8xl font-black tracking-tighter text-white">
          {currentStreak}<span className="text-3xl text-white/20 ml-2 italic">days</span>
        </h2>
      </div>
      ...
      <div className="flex flex-col items-center md:items-end gap-2 text-right">
        <p className="text-white/40 text-xs font-bold uppercase tracking-widest">Personal Legend</p>
