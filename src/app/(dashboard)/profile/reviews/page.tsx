            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex gap-2 shrink-0">
                  <button onClick={() => push("Review editing coming soon!", "info")} className="p-2 rounded-lg text-subtle hover:text-foreground hover:bg-surface transition-colors">
                    <Edit2 size={13} />
                  </button>
              ...
              <div className="flex items-center justify-between pt-2 border-t border-border text-[9px] text-subtle">
                ...
                <Link href={`/anime/${r.anime.id}/reviews`} className="text-accent-bright/60 hover:text-foreground transition-colors font-black uppercase tracking-widest">
                  View on Anime →
                </Link>
              </div>
            </motion.div>
