...
const BADGE_DB: Record<string, BadgeData> = {
  ...
  "binge-master": {
    ...
    rarityBg: "bg-amber-500/10 border-amber-500/25",
...
const EARNERS_DB: Record<string, Earner[]> = {
  "fire-walker": [
    ...
    { id: "e5", username: "Cipher_Ronin",  avatar: "C", avatarColor: "from-amber-500 to-orange-600",  earnedDate: "Apr 10, 2026", level: 61 },
  ...
  "centurion": [
    ...
    { id: "e2", username: "Cipher_Ronin",  avatar: "C", avatarColor: "from-amber-500 to-orange-600",  earnedDate: "Apr 30, 2026", level: 61 },
...
function defaultEarners(badge: BadgeData): Earner[] {
  return [
    ...
    { id: "e3", username: "Cipher_Ronin",  avatar: "C", avatarColor: "from-amber-500 to-orange-600",  earnedDate: "Apr 25, 2026", level: 61 },
        ...
        <div className="grid md:grid-cols-[1fr_340px] gap-8">
          <div className="space-y-8">
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white/[0.02] border border-white/8 flex items-center gap-5"
            >
              <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-amber-500/20 to-orange-500/20 border border-amber-500/25 flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="text-[11px] text-white/35 mt-0.5 uppercase tracking-widest font-black">
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white/[0.02] border border-white/8 space-y-4"
            >
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30">
                Requirement
              </p>
              <div className="flex items-center justify-between text-sm">
                <span className="font-bold text-white/70">{badge.requirement}</span>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {earners.map((earner, i) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-xs font-black text-white">{earner.username}</p>
                      <p className="text-[9px] text-white/30 mt-0.5">Lv. {earner.level}</p>
                      <p className="text-[8px] text-white/20 mt-1">{earner.earnedDate}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
