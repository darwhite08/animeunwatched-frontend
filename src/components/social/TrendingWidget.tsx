  ...
  return (
    <div className="p-5 rounded-2xl bg-surface border border-border space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Link href="/community/trending" className="text-[9px] font-black uppercase tracking-widest text-accent-bright/60 hover:text-foreground transition-colors flex items-center gap-1">
      ...
      <div className="space-y-1">
        {realTrending.map(({ tag, posts, hot }, i) => (
          ...
          >
            <div className="flex items-center gap-2">
              <Hash size={11} className="text-subtle group-hover:text-foreground transition-colors" />
