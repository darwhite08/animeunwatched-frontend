...
const GENRES = [
  ...
  { name: "Psychological", gradient: "from-purple-900/40 to-purple-950/10", border: "border-purple-900/30",  accent: "text-purple-400",  emoji: "🧠" },
  { name: "Fantasy",       gradient: "from-emerald-900/40 to-emerald-950/10",border: "border-emerald-900/30",accent: "text-emerald-400", emoji: "🐉" },
  { name: "Romance",       gradient: "from-pink-900/40 to-pink-950/10",     border: "border-pink-900/30",    accent: "text-pink-400",    emoji: "💕" },
  { name: "Sci-Fi",        gradient: "from-cyan-900/40 to-cyan-950/10",     border: "border-cyan-900/30",    accent: "text-cyan-400",    emoji: "🚀" },
  { name: "Horror",        gradient: "from-red-950/40 to-black/40",         border: "border-red-950/30",     accent: "text-red-300",     emoji: "👹" },
  { name: "Comedy",        gradient: "from-yellow-900/40 to-yellow-950/10", border: "border-yellow-900/30",  accent: "text-yellow-400",  emoji: "😂" },
  { name: "Thriller",      gradient: "from-slate-900/40 to-slate-950/10",   border: "border-slate-800/30",   accent: "text-slate-300",   emoji: "🔪" },
  { name: "Seinen",        gradient: "from-blue-900/40 to-blue-950/10",     border: "border-blue-900/30",    accent: "text-blue-400",    emoji: "📖" },
  { name: "Shonen",        gradient: "from-orange-900/40 to-orange-950/10", border: "border-orange-900/30",  accent: "text-orange-400",  emoji: "🔥" },
