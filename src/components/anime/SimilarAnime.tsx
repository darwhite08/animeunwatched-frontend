          ...
          >
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs font-black text-foreground uppercase italic tracking-tighter leading-tight truncate group-hover:text-foreground transition-colors duration-300">
                  {anime.title}
                </p>
